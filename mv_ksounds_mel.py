...
import subprocess
# flag = 0
filepath = "/data1/lanhaoyuan/datasets/ucf101/ucf101_wholeaudiomel/470x256/"
dst_path = "/data1/lanhaoyuan/datasets/ucf101/ucf101_rgbflowspec/wholemel/470x256/"
for classname in  os.listdir(filepath):
    ...
    for vname in os.listdir(classpath):
        ...
        #     flag = framename[-2 :]
        pic_num = 0
        for picname in os.listdir(vpath):
            pic_num += 1
            flag = picname[: -4]
            picpath = os.path.join(vpath, picname)
    ...
    #     continue
            ...
            fw = open('log_cp_ucf101_wholeaudio.txt', 'a')
            fw.write(cmd)
            fw.write('\n')
            fw.close()
            subprocess.call(cmd, shell = True)
            # break
        fw = open('log_ucf101_wholeaframenum.txt', 'a')
        fw.write('{} {}\n'.format(vname, pic_num))
        fw.close()
